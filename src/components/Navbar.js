  ...
  return (
    ...
    >
      ...
      <NavLinks>
        ...
        {/* Explore Dropdown */}
        <NavLink
          onMouseEnter={() => toggleDropdown("explore", true)}
          onMouseLeave={() => toggleDropdown("explore", false)}
        >
          <a href="#">Features</a>
          <DropdownMenu isOpen={dropdownOpen.explore}>
            <Link to="/categories">Grammar Battle Mode</Link>
            <Link to="/trending">Scan and Fix</Link>
            <Link to="/new">Auto Translate and Hinglish Fever</Link>
            <Link to="/new">Sing and Correct Mode</Link>
          </DropdownMenu>
        </NavLink>
        <NavLink>
